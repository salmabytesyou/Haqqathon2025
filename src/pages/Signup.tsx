      ...
      <div className="flex flex-row gap-x-12 max-w-4xl w-full items-center justify-center mx-auto">
        ...
        <div className="flex-1 flex items-center justify-center">
          <form onSubmit={handleSubmit} className="bg-white p-12 rounded-2xl shadow-xl w-full max-w-md flex flex-col gap-6 items-center">
            ...
            />
            <label className="text-lg font-medium text-gray-700 w-full text-left" htmlFor="fname">First name:</label>
            <input
              id="fname"
              type="text"
              className="border border-gray-300 rounded px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg"
            ...
            />
            <label className="text-lg font-medium text-gray-700 w-full text-left" htmlFor="lname">Last name:</label>
            <input
              id="lname"
              type="text"
              className="border border-gray-300 rounded px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg"
            ...
            />
            <button type="submit" className="mt-6 py-4 w-full text-2xl font-bold rounded-2xl bg-gradient-to-r from-[#75b3b8] to-[#8dbf7f] text-white shadow-xl hover:scale-105 transition-all">Sign Up</button>
          </form>
        </div>
      </div>
    </div>
